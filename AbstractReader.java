...
public class AbstractReader {
	...
	private final String PROP_KEY_DATA_URL_CLOSURE = "DATA_URL_HWYCLOSURE";
	...
	private String STREET_PATTERN;
	private CharSequence SPLIT_PATTERN;
	private CharSequence DATE_PATTERN;
	private CharSequence WEEKDAY_AND_TIME_PATTERN;
	private CharSequence TIME_PATTERN;
	...
	// HashMap to store cityBoundary
	private HashMap<String, String[]> cityBoundaryMap;    

	// HashMap to store eventKWord
	...
	private LinkedHashMap<String, String> countyCityMap;
	...
	// Error record file
	private final String ERROR_RECORDS_FILE = this.getClass().getName() + "_Error.txt";
...
//			prop.load(is);
	...
	private boolean loadCityBoundary() {
		...
		String[] tokens = null;
		String[] latlons = null;
		cityBoundaryMap = new HashMap<String, String[]>();
		int latlonNum = 0;
