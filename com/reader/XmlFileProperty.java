...
public class XmlFileProperty {
	...
	public static final String TC_SEPARATE_SIGN = "TcSeparateSign";
	public static final String REVERSE_GEOCODING_FLAG = "ReverseGeocodingFlag";
	public static final String STATE = "State";
	public static final String STATES = "States";
	public static final String CITY = "City";
	public static final String COUNTY= "County";
	public static final String CITY_SET = "CitySet";
	...
	public static final String DATA_URL_LIST = "DataURLList";
